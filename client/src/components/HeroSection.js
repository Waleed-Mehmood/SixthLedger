...
//           <li className="hover:text-orange-500 cursor-pointer text-xl">Services</li>
//           <li className="hover:text-orange-500 cursor-pointer text-xl">About</li>
//           <li className="hover:text-orange-500 cursor-pointer text-xl">Team</li>
//           <li className="hover:text-orange-500 cursor-pointer text-xl">Contact</li>
//         </ul>
//       </nav>
...
//           </p>
//           <button className="mt-5 px-6 py-2 bg-orange-500 text-white rounded-full hover:bg-orange-600 transition">
//             Book Consultation
//           </button>
//         </div>
//       </div>
